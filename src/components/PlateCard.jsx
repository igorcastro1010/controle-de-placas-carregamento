...
export default function PlateCard({ item, index, visualOrder, itemsLength, busyId, canViewAudit, canManageQueue, onAction, onMove, onEdit, onAudit, onPriority, onOtherLocation, onMoveToPosition }) {
